...
export const Navbar = () => {
            ...
            <div className={styles.navbarUpperSection}>
                <div>
                    <Link to="/">
                          ...
                          <img height="110" width="160" src="logoResa2.png"  />
                    </Link>
                </div>
    ...
    <ul>
        ...
        <li className={styles.indianFlag}>
            <img src="tunLogo.png" alt="Tunisia's flag" />
        </li>
        <li>
            <svg className={styles.questionIcon} height="24" width="24" viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false">
